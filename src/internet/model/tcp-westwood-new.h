...
#ifndef TCP_WESTWOOD_NEW_H
#define TCP_WESTWOOD_NEW_H
...
namespace ns3
{
     ...
     *
     * \brief An implementation of TCP WestwoodNew
     *
     ...
     */
    class TcpWestwoodNew : public TcpNewReno
    {
    public:
        /**
         ...
         */
        TcpWestwoodNew(const TcpWestwoodNew &sock);
        virtual ~TcpWestwoodNew(void);

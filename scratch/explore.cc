...
NS_LOG_COMPONENT_DEFINE("explore");
...
int main(int argc, char *argv[])
{
    ...
    LogComponentEnable("explore", LOG_DEBUG);
    ...
    Rmobility.SetMobilityModel("ns3::ConstantPositionMobilityModel");
    ...
    sinkAddress = Inet6SocketAddress(interfaces.GetAddress(1, 0), sinkPort);
    NS_LOG_DEBUG(interfaces.GetAddress(1, 0));
